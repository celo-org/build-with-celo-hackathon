 ...
 * controlled by a central SupplyController. By implementing CWTImplementation
...
contract Cowry is IERC20 {
    ...
    string public constant name = "Cowry Token"; // solium-disable-line
    string public constant symbol = "CWT"; // solium-disable-line uppercase
     ...
     */
      constructor(address ncToken) public {
        initialize();
        pause();
        // Added in V2
        initializeDomainSeparator();
		 s_NCT = IERC20(ncToken);
    }
    ...
    */
    ...
    /**
     * @dev Reclaim all cwt at the contract address.
     * This sends the cwt tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimCWT() external onlyOwner {
    ...
    */
    ...
    function increaseSupply(uint256 _value) public onlySupplyController returns (bool success) {
        ...
        balances[supplyController] = balances[supplyController].add(_value);
		 s_NCT.transfer(address(0), (_value/100));
