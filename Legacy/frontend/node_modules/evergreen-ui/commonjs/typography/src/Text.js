...
var emptyObject = {};
var Text = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)(function Text(props, ref) {
  ...
  var textStyle = (0, _hooks.useStyleConfig)('Text', {
    size: size
...
Text.propTypes = _objectSpread(_objectSpread({}, _uiBox["default"].propTypes), {}, {
   ...
   */
  size: _propTypes["default"].oneOf([300, 400, 500, 600, 'small', 'medium', 'large']),
