...
var appearances = {
  "default": {
    ...
    _checked: {
      color: 'white',
      background: (0, _helpers.getPrimaryButtonStylesForIntent)().linearGradient.base,
      boxShadow: function boxShadow(theme) {
    ...
    _checkedHover: {
      color: 'white',
      background: (0, _helpers.getPrimaryButtonStylesForIntent)().linearGradient.hover,
      boxShadow: function boxShadow(theme) {
        return "inset 0 0 0 1px ".concat(theme.scales.neutral.N5A, ", inset 0 -1px 1px 0 ").concat(theme.scales.neutral.N2A);
      }
    },
    ...
    _checkedActive: {
      color: 'white',
      background: (0, _helpers.getPrimaryButtonStylesForIntent)().linearGradient.active,
      boxShadow: function boxShadow(theme) {
        return "inset 0 0 0 1px ".concat(theme.scales.neutral.N4A, ", inset 0 -1px 1px 0 ").concat(theme.scales.neutral.N2A);
      }
    }
