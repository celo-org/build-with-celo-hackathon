...
var _FileCard = _interopRequireDefault(require("../src/FileCard"));
...
var renderWithProps = function renderWithProps() {
  ...
  return (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_FileCard["default"], (0, _extends2["default"])({}, props, {
    "data-testid": testId
  })));
};
  ...
  describe('props', function () {
    ...
    describe('isInvalid', function () {
      it('should render InfoSignIcon when true', function () {
        ...
        var fileCard = _react2.screen.getByTestId(testId);
    ...
    describe('name', function () {
      it('should render name', function () {
        var name = _faker.faker.system.fileName();
    ...
    describe('sizeInBytes', function () {
      it('should render humanized size', function () {
        var sizeInBytes = _faker.faker.datatype.number({
          min: 1024,
          max: 10 * 1024 * 1024
        });
        ...
        expect(_react2.screen.getByText(_humanizePlus["default"].fileSize(sizeInBytes, 0))).toBeInTheDocument();
      });
    });
    describe('src', function () {
      describe('when src is non-empty', function () {
        it.each([_constants.MimeType.css, _constants.MimeType.doc, _constants.MimeType.mp3, _constants.MimeType.mp4])('should not render <img /> when type is %p', function (type) {
          var src = _faker.faker.image.animals();
        ...
        it.each([_constants.MimeType.png, _constants.MimeType.gif, _constants.MimeType.jpeg])('should render <img /> when type is %p', function (type) {
          var src = _faker.faker.image.animals();
