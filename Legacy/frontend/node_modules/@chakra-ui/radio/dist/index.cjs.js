...
var VisuallyHidden = (0, import_system2.chakra)("span", {
  baseStyle: visuallyHiddenStyle
});
VisuallyHidden.displayName = "VisuallyHidden";
var VisuallyHiddenInput = (0, import_system2.chakra)("input", {
  baseStyle: visuallyHiddenStyle
});
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react5.useId)()}`;
  ...
  const [isFocusVisible, setIsFocusVisible] = (0, import_react5.useState)(false);
  const [isFocused, setFocused] = (0, import_react5.useState)(false);
  const [isHovered, setHovering] = (0, import_react5.useState)(false);
  const [isActive, setActive] = (0, import_react5.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react5.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react5.useEffect)(() => {
    return (0, import_focus_visible.trackFocusVisible)(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react5.useCallback)((event) => {
  ...
  const onKeyUp = (0, import_react5.useCallback)((event) => {
    if (event.key === " ") {
      setActive(false);
    }
  }, [setActive]);
  const getRadioProps = (0, import_react5.useCallback)((props2 = {}, ref = null) => ({
    ...props2,
    ref,
  ...
  const getInputProps = (0, import_react5.useCallback)((props2 = {}, ref = null) => {
...
// src/radio.tsx
var Radio = (0, import_system3.forwardRef)((props, ref) => {
  const group = useRadioGroupContext();
  const { onChange: onChangeProp, value: valueProp } = props;
  const styles = (0, import_system3.useMultiStyleConfig)("Radio", { ...group, ...props });
  const ownProps = (0, import_system3.omitThemingProps)(props);
  const {
    spacing = "0.5rem",
    children,
  ...
  const [layoutProps, otherProps] = split(htmlProps, import_system3.layoutPropNames);
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.label, {
    ...
    ...inputProps
  }), /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.span, {
    className: "chakra-radio__control",
    ...checkboxProps,
    __css: checkboxStyles
  }), children && /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.span, {
