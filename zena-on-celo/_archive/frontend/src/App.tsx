          ...
          <div className="container relative w-full px-8 pt-32 pb-24 mx-auto lg:px-4">
            <div className="flex flex-col w-full mb-12 text-left lg:text-center">
              ...
              <p className="mx-auto text-xl leading-snug text-slate-500 lg:w-1/2">
                a Web3 climate-app enabling users to combine learning with
          ...
          <div className="container px-5 py-32 mx-auto lg:px-24">
            <div className="flex flex-col w-full mb-20 text-left lg:text-center">
              ...
              <p className="mx-auto text-lg leading-snug text-slate-500">
                ...
                learning chapters and quests. These tokens can be exchanged into
                a certificate NFT, sequestering CO2.
              </p>
              ...
              <div className="flex p-4 lg:w-1/3">
                ...
                <div className="flex-grow pl-6">
                  ...
                  <p className="mt-6 text-lg text-slate-500">
                    ...
                    learning chapters. Start your journey into Web3, or any
                    other topic prepared by our educators.
                  </p>
                </div>
              </div>
              <div className="flex p-4 lg:w-1/3">
                ...
                <div className="flex-grow pl-6">
                  ...
                  <p className="mt-6 text-lg text-slate-500">
                    Thanks to Toucan Protocol, ZENA catches real carbon for
                    every successfully mastered chapter. Let your ZENA tree
                    grow!
                  </p>
                </div>
              </div>
          ...
          <div className="container items-center px-5 py-24 mx-auto lg:px-24">
            <div className="flex flex-col w-full mb-6 text-left lg:text-center">
              <h2 className="mb-6 font-serif text-3xl font-bold tracking-tighter text-[#385738] md:text-8xl lg:text-6xl">
                ...
                fun and change the world with us while learning!
              </h2>
            </div>
          </div>
        </section>
          ...
          <div className="px-5 py-12 mx-auto max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-12">
            <div className="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
              <span className="text-white hover:text-blue-600">
                Built during Celo hackathon 2022
              </span>
