...
export default function Badge() {
  ...
  return (
    ...
    //   </style>
    //   <line x1="20" y1="500" x2="820" y2="500" stroke="green" stroke-width="2"></line>
...
<svg width="750px" height="306px" viewBox="0 0 750 306" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <g id="Embed-SVG-to-Generate" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
        <rect fill="#FFFFFF" x="0" y="0" width="750" height="306"></rect>
        <rect id="Rectangle" stroke="#000000" stroke-width="3" x="10.5" y="10.5" width="727" height="232" rx="3" fill="#FFFFFF"></rect>
        <rect id="Rectangle" fill="#000000" x="9" y="239" width="730" height="57"></rect>
        <text id="AMADAO-VERIFIED-SPON" font-family="IBMPlexMono-Regular, IBM Plex Mono" font-size="36" font-weight="normal" letter-spacing="0.33882336" fill="#FFFFFF">
            <tspan x="115.703531" y="281">AMADAO VERIFIED SPONSOR </tspan>
        </text>
        <g id="Group" transform="translate(267.927486, 12.921477)">
            <text id="🌳" font-family="AppleColorEmoji, Apple Color Emoji" font-size="160" font-weight="normal" line-spacing="200" letter-spacing="1.5058816" fill="#000000">
                <tspan x="17.072514" y="182.078523">🌳</tspan>
            </text>
            <polygon id="Hexagon-Copy" stroke="#454545" stroke-width="4" stroke-linecap="square" transform="translate(99.946770, 113.332229) rotate(-1.084576) translate(-99.946770, -113.332229) " points="3.94315844 55.7392 101.533365 1.83222873 197.800566 60.9821263 195.721505 170.801294 97.3678081 224.832229 2.09297276 167.135581"></polygon>
        </g>
        <text id="CO2-Offset" font-family="IBMPlexMono-Regular, IBM Plex Mono" font-size="90" font-weight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="42" y="150">CO2</tspan>
            <tspan x="60" y="251.710297" font-size="48">Offset</tspan>
        </text>
        <g id="link-solid" transform="translate(690.000000, 251.000000)" fill="#FFFFFF" fill-rule="nonzero">
        ...
        <text id="2,365-Tons" font-family="IBMPlexMono-Regular, IBM Plex Mono" font-size="72" font-weight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="491" y="130">{data?.height}</tspan>
            <tspan x="725.72" y="141.568237" font-size="90"></tspan>
            <tspan x="610.52" y="211.568237" font-size="48">Tons</tspan>
        </text>
    </g>
</svg>
