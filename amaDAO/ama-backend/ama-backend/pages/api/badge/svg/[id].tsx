...
export default function badgeSVGHandler(
  req: NextApiRequest,
  ...
  logger.logInfo("badgeSVGHandler", "Id", id);
  // const data = {
  //   height: 200
  // }
  const fetcher = (url: string) => fetch(url).then((res) => res.json());

  //const { data, error } = useSWR('/api/sponsor/'+id, fetcher)
  ...
  res.status(200).send(`
    ...
    <g id="Embed-SVG-to-Generate" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        <text id="AMADAO-VERIFIED-SPON" font-family="IBMPlexMono-Regular, IBM Plex Mono" fontSize="36" fontWeight="normal" letterSpacing="0.33882336" fill="#FFFFFF">
        ...
        <text id="CO2-Offset" font-family="IBMPlexMono-Regular, IBM Plex Mono"  fontSize="80" fontWeight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="42" y="130">CO2</tspan>
            <tspan x="60" y="211.568237" fontSize="48">Offset</tspan>
        </text>
        <a href="`+"./badge/detail/"+{id}+`" target="_blank">
        ...
        <text id="tons" font-family="IBMPlexMono-Regular, IBM Plex Mono"  fontSize="80" fontWeight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="511" y="130">`+10+`</tspan>
