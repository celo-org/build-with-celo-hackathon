    ...
    <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-dark bg-white dark:border-nft-black-1 border-nft-gray-1">
      <div className="flex flex-1 flex-row justify-start">
        <Link href="/">
          <div className="flexCenter cursor-pointer md:hidden">
            ...
            <p className="dark:text-white text-nft-black-1 font-semibold text-lg ml-1">CNFT MARKETPLACE</p>
          </div>
        </Link>
        <Link href="/">
          <div
      ...
      <div className="flex flex-initial flex-row justify-end ">
        ...
        <div className="flex md:hidden">
          ...
          <div className="ml-4">
            <p className="dark:text-white text-nft-black-1 font-semibold text-lg ml-1"><ButtonGroup router={router} setActive={setActive} setIsOpen={setIsOpen} /></p>
          </div>
        </div>
<div className="flex md:hidden">
