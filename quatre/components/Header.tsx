...
const Header = () => {
  return (
    <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginHorizontal:15}}>
      ...
      <View style={{flexDirection:"row", backgroundColor:"white", width:"70%", borderRadius: 10 }}>
        
        <TextInput placeholder="Search" style={{ borderWidth: 1, borderColor:"#B1B1B1", flex: 1, padding: 10, }}/>
