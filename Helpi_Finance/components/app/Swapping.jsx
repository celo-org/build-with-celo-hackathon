...
import { helpiAddress, celoAddress } from "../../contracts/addresses";
// Uniswap -------->
...
function Swapping() {
  ...
  // const POOL_ADDRESS = "0xbbb998d4c99e6e272d6f612e644fa5be743fe4f4"; // Pool Address
                ...
                <div className="bg-slate-700 rounded-2xl px-4 py-4 mb-4">
                  ...
                  <div className="flex items-center justify-between w-full">
                    <input
                      ...
                      className="bg-transparent w-8/12 flex items-center text-2xl leading-12 font-semibold text-gray-400 border-none outline-none pt-1"
                    />

                    <select className="bg-transparent w-auto text-base font-semibold text-gray-400 border-none active:border-none outline-none ">
                ...
                <div className="bg-slate-800 rounded-2xl px-4 py-4">
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <select
                      ...
                      className="bg-transparent w-auto text-base font-semibold text-gray-400 border-none active:border-none outline-none "
                    >
