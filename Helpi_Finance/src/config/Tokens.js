  ...
  42161: [
    {
      name: "HLP",
      symbol: "HLP",
      address: getContract(42161, "HLP"),
      decimals: 18,
    },
    {
      name: "Escrowed HLP",
      symbol: "esHLP",
      address: getContract(42161, "ES_HLP"),
      decimals: 18,
    },
    {
      name: "HLP LP",
      symbol: "THLP",
      address: getContract(42161, "THLP"),
      decimals: 18,
    },
  ],
  43114: [
    {
      name: "HLP",
      symbol: "HLP",
      address: getContract(43114, "HLP"),
      decimals: 18,
    },
    {
      name: "Escrowed HLP",
      symbol: "esHLP",
      address: getContract(43114, "ES_HLP"),
      decimals: 18,
    },
    {
      name: "HLP LP",
