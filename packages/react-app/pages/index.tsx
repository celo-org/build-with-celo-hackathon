...
import { Tabs, Tab, Typography, Box, InputLabel, Select, MenuItem } from "@mui/material";
...
export default function App() {
    ...
    return Object.values(contracts).map((contract, key) => {
      ...
      return (
        <TabPanel value={value} index={key} key={key}>
          <ContractLayout
            contractName={contractName[key - 1]}
  ...
  return (
    <AppLayout title="Eco Construct" description="Eco Construct">
      <Box sx={{ flexGrow: 1 }}>
