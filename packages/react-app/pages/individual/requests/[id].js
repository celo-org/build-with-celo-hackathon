                                    ...
                                    <div className='px-6 py-6 sticky top-0 border border-gray-300 rounded-lg'>
                                        ...
                                        <div>
                                            ...
                                            <div className='flex items-center gap-4 mt-5 mx-auto'>
                                                <button className='px-9 py-3 border border-gray-300 bg-white text-gray-700 rounded-full w-1/2' >Raise Dispute</button>
                                                <button className='px-9 py-3 border border-[#DD7D37] bg-[#DD7D37] text-white rounded-full  w-1/2'>Fulfill Request</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
