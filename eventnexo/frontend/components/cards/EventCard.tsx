...
export default function EventCard() {
  return (
    <div className="w-1/3 flex-shrink-[0] group p-0 m-0">
      <div className="mb-10 px-3 py-0 relative w-full inline-block flex-shrink-[0]">
        <div className="relative cursor-pointer w-full p-0 m-0">
          <div className="group-hover:-translate-x-1 duration-75 transition ease-out bg-white relative border-black border-2 z-[2] rounded-[8px]">
            <div className="p-10">
              ...
              <p className="w-full text-xs font-bold overflow-hidden h-10 text-ellipsis whitespace-nowrap leading-5">
                ...
                contracts, so later you can push updates to your smart contract
                logic
              </p>
          ...
          <div className="abolute left-0 top-0 right-0 bottom-0 rounded-[12px]  border-black border-2 z-[1] bg-[#00D26D] opacity-0 group-hover:opacity-100"></div>
        </div>
      </div>
    </div>
  );
